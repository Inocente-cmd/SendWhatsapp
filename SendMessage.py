...
# el chat o el frupo
button = WebDriverWait(driver, 25).until(EC.presence_of_element_located((By.XPATH, '//*[@id="pane-side"]/div[1]/div/div/div[3]/div/div/div/div[2]/div[1]/div[1]/span'))).click()
